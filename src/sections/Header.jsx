    ...
    return(
        <header className="" >
            ...
            <div className="text-white text-center font-opensans text-6xl py-60 align-middle uppercase">
                <h1 className="mb-2 font-light animate__animated animate__fadeInDown">Olá, eu sou o</h1>
                ...
                <button className="text-5xl hover:text-slate-200 bg-slate-950 hover:bg-black pt-4 pb-6 px-20 rounded-xl mt-4 uppercase animate_animated animate_fadeIn">Ver projetos</button>
            </div>
        </header>
    )
}
